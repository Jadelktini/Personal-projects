...
class MainWidget(RelativeLayout):
    ...
    from user_actions import on_keyboard_up, on_touch_down, keyboard_closed, on_touch_up, on_keyboard_down
    ...
    menu_title = StringProperty("T   E   S   L   A   -   X")
    ...
    def update(self, dt):
        ...
        if not self.check_ship_collisions() and not self.state_game_over:
            ...
            Clock.schedule_once(self.play_voice_game_over, .25)
            print("GAME OVER")
